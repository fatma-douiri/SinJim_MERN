              ...
              <div className="card p-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ml-3 w-100">
                    ...
                    <div className="button mt-2 d-flex flex-row align-items-center"> <button className="btn btn-sm btn-outline-primary w-100" onClick={logout} >Logout </button> <button className="btn btn-sm btn-primary w-100 ml-2">Add Poll</button> </div>
                  </div>
                </div>
              </div>
            </div>
